...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('login', '0003_alter_userprofile_uuid'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room_type', models.CharField(choices=[('public', 'Public'), ('private', 'Private'), ('direct', 'Direct Message'), ('github_repo', 'GitHub Repository')], default='public', max_length=20)),
